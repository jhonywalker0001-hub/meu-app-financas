...
# REMOVIDO: sqlite3 (built-in do Python)
# ADICIONADO: numpy (dependencia do pandas), pandas
requirements = python3,kivy==2.2.1,kivymd,numpy,pandas,openpyxl,fpdf2
...
# This can be useful to avoid updates with offline builds or to save bandwidth
...
# "in the future" will be the default, but not yet for now as it would break
# several existing build recipes
# p4a.setup_py = false
